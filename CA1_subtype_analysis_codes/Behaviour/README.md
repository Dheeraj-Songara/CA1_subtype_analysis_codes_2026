...
Freezing is defined strictly as an absence of movement (excluding respiration), quantified here as a frame-by-frame motion score dropping below a validated threshold for a sustained minimum duration (default: 0.5 seconds).
